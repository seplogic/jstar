...
let class2args cl = PS.mkString (class_name2str cl)

(* create n.si|->e *)
let mk_pointsto n si e = PS.mkSPred ("field", [n; si; e])

(* create cl1 <: cl2 *)
let mk_subtype1 a1 a2 = PS.mkPPred ("subtype", [a1; a2])
...
let mk_type1 a1 a2 = PS.mkPPred (objtype_name, [a1; a2])
let mk_type var cl = mk_type1 var (class2args cl)

let mk_type_all var cl = PS.mkPPred (objtype_name, [var; base_type2args cl])
...
let mk_objsubtyp1 a1 a2 = PS.P_PPred("objsubtype", [a1; a2])
let mk_objsubtyp var cl = mk_objsubtyp1 var (class2args cl)

(* create var </: cl  (is not a subtype of) *)
let mk_objnotsubtyp var cl = PS.P_PPred("notobjsubtype", [var; class2args cl])

(* create var statictype cl *)
let mk_statictyp1 a1 a2 = PS.mkPPred ("statictype", [a1; a2])
